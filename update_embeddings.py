...
list_of_maps: list[tuple[str, str]] = [
    ("Mechanical Engineering", "https://raw.githubusercontent.com/cmccomb/map-of-mech/"),
    ("Civil & Environmental Engineering", "https://raw.githubusercontent.com/cmccomb/map-of-civil/"),
    ...
    ("CMU-Africa", "https://github.com/cmccomb/map-of-cmu-africa"),
]
...
tsne_embeddings: NDArray = sklearn.manifold.TSNE(n_components=2, random_state=42, verbose=True).fit_transform(embeddings)
